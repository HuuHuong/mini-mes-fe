...
import { VectorIconIcon } from "@assets/icons";
    ...
    return (
      ...
      >
        {loading ? (
          ...
          leftIcon && (
            <VectorIcon icon={leftIcon} size={iconSize[size]} color="white" />
          )
        )}
        <span>{label}</span>
        {!loading && rightIcon && (
          <VectorIcon icon={rightIcon} size={iconSize[size]} color="white" />
        )}
      </button>
    );
  },
